...
#         print(f"self.user_email: {self.user_email}")
...
#         print(f"Group added: {self.group_name}")
...
#             print(f"Sending message to group: {recipient_group}")
...
#             print(f"Sending Notication to group: {notification_group}")
...
#             )
            ...
            # for attachment in attachments:
            #     file_url = attachment.get("url")  # Get the file URL
            #     original_name = attachment.get("original_name")  # Get the original file name
            ...
            # attachment_obj = await MessageAttachment.objects.acreate(
            #     file_url=file_url,
            #     original_name=original_name,
            #     file_type=file_type,
            #     # message=message,  # Associate the attachment with the message
            # )

#             attachment_details.append({
#                 "url": attachment_obj.file_url,
#                 "file_name": attachment_obj.original_name,
